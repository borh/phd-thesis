...
![Adapted from @schramm1955's communication model](schramm-model.pdf)
...
\includegraphics[height=\textheight]{schramm-context.pdf}
...
![Adapted from @schramm1997communication's communication model (p. 54) with additions by me in blue](schramm-model-new.pdf)
...
![Relations between register, topic and readability](register-topic-readability.pdf)
...
\begin{tcolorbox}[title=Proposed models \cite{CASTELJHodoscek2012}]
...
# Writing Assistance System (Ch. 3)
...
\includegraphics<1>[height=1.2\textheight]{system-architecture-overview-1.pdf}
\includegraphics<2>[height=1.2\textheight]{system-architecture-overview-2.pdf}
\includegraphics<3>[height=1.2\textheight]{system-architecture-overview-3.pdf}
...
\includegraphics[height=.85\textheight]{natsume-overview.pdf}

### Collocation Search Interface

\centering
\includegraphics[width=1.01\linewidth,height=.8\textheight]{natsume-compare.pdf}


### Genre Comparison Interface

![Comparing collocations of 'jikken' with 'yaru', 'suru' and 'okonau' across genres](natsume-genre-compare.pdf)
...
\centering
\includegraphics[height=.4\textheight]{nutmeg-interface-summary.pdf}
...
\centering
\includegraphics[height=.55\textheight]{nutmeg-writing-interface.pdf}
...
### Register Identification Method (Ch. 2)
...
![Latent Dirichlet Analysis topic model used in \cite{NCHodoscek2012E} (unrefereed)](lda-topic-model.pdf)
